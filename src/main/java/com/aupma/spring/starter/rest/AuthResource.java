...
public class AuthResource {
    ...
    /**
     * Get TOTP QR code image for MFA verification
     * @param user Injected by @CurrentUser annotation
     * @return String - Base64 encoded QR code png image
     */
    ...
    /**
     * Verifies the TOTP code generated by an Authenticator app and generates an access token.
     *
     * @param authentication Authentication Provided by Spring Security
     * @param code           TOTP Code
     * @return ResponseEntity<AuthResponseDTO>
     */
    @PostMapping("verify-totp")
    public ResponseEntity<AuthResponseDTO> verifyTotp(Authentication authentication, @RequestParam String code) {
